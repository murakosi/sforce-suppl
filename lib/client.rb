...
=end
      # Override optional Savon attributes
      # To avoid SSL error, add ssl_ca_cert_file option
      # and change savon_options to instance variable to reuse in login()
      @savon_options = {}
...
=end
      # To avoid SSL error, use ssl_ca_cert_file options included in @savon_options
      @client = Savon.client({
        wsdl: @wsdl,
        soap_header: @headers,
        convert_request_keys_to: :none,
